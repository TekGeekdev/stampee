...
<body>
        <nav id="nav-principale" class="plein-plan">
            <div class="barre-principale">
                <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 669.78 282">
                    <defs>
                        <style>
                            .cls-4 {
                                fill: #ffffff
                ...
                <input type="checkbox" id="menu-mobile" aria-label="bouton pour menu mobile">
            </div>
            <ul class="barre-secondaire">
                <li><a href="#">Enchères du moment</a></li>
                <li><a href="#">Actualités</a></li>
                <li><a href="#">Coup de coeur du lord</a></li>
